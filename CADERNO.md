...
|---|---|---|---|---|---|---|
| Leite in natura | 19,5 L | 19,5 L | 19,5 L | 19,5 L | 19,5 L | 26,5 L |
...
**Mistura — igual em TODOS os sabores (por tacho):** 500 ml de leite + 1 colher de sal (15 g) + 14 colheres de antimofo (= 70 g de sorbato). **Os 500 ml da mistura SOMAM por cima da base** (19 + 0,5 = **19,5 L** nas cocadas T/L/B/C/P; 26 + 0,5 = **26,5 L** na Zero) — confirmado por Leonardo **20/06** (retoma o entendimento original de 22/05; reverte o engano de 15-17/06 que tratava a mistura como inclusa nos 19/26). Sal e sorbato entram como insumos da receita.
...
*Feito (metade do teto):* a página Sugestão de Cocada agora **puxa a capacidade efetiva do dia do módulo Equipe** (`get_capacidade_efetiva_dia(data, 'producao_cocada')` = soma de tachos/dia de quem está presente) e pré-preenche o teto `capacidade_tachos`. A Gestão ajusta. A UI mostra só a contagem de presentes + banda min-max (sem nomes próprios — regra dos departamentos). Responde à pergunta real da Gestão: *"a Produção dá conta hoje?"*. Quando não há presença lançada, cai no comportamento antigo (0 = sem teto) e sugere cadastrar na página Equipe.

*Falta (a outra metade — piso dinâmico):* modelar o "pedir mais quando bate a meta cedo". Isso é o oposto de um teto — é um piso que sobe com folga de capacidade. Precisa de **histórico de headcount × produção observada** (N semanas de presença + folha) pra estimar a correlação. Não dá pra fazer sem coletar esses dados primeiro. Vira capítulo de PCP no TCC (Goldratt — *Theory of Constraints*: gargalo é mão de obra, capacidade ociosa custa). Próximo passo de coleta: garantir que a Embalagem/Produção lancem presença diária na página Equipe.
