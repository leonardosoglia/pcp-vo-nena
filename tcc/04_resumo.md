...
industrial brasileira, em substituição ao controle manual em folhas de
papel. O sistema, estruturado em três camadas funcionais — digitalização,
visualização/análise e sugestão automática — implementa em pequena escala
funcionalidades classicamente restritas a grandes indústrias: explosão de
necessidades de materiais (MRP simplificado), Curva ABC de produtos,
detecção de anomalias operacionais por aprendizado de máquina
(*Isolation Forest*) e calibração contínua de metas por média móvel. Uma
...
conversacionais na operação industrial cotidiana.

**Palavras-chave:** Planejamento e Controle da Produção. Pequena
